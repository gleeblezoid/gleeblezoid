...
In conclusion, I've tried to select a few relevant components of the user journey which can be quantitatively measured and relate directly to the user's experience of trying to buy in-game currency in our app. In prioritizing user happiness and where we can improve reliability based on SLOs I've tried to stay away from using indicators which depend more on the performance of a 3rd party (generally the Play Store or user's network provider) or implementations which require intrusive data gathering on the client device. By selecting SLIs in this way we can calculate meaningful error budgets which allow us to improve the purchasing experience for users looking to get some more in-game currency via ongoing development.
